...
![publish-project](./imgs/publish.png)
...
![choose-map-slot](./imgs/choose_map_slot.png)

Please wait so that the map can be published successfully.  
![wait-for-map-publish](./imgs/wait_map_publish.png)
